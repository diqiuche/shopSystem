...
<body style="background:#f0f9fd;">
    ...
    <dd>
    <div class="title">
    <span><img src="<%=path %>/static/images/leftico01.png" /></span>管理信息
    </div>
    	<ul class="menuson">
        ...
        <li>
            <div class="header">
            <cite></cite>
            <a href="index.html" target="rightFrame">用户信息管理</a>
            <i></i>
            </div>
            <ul class="sub-menus">
            <li><a href="<%=path%>/jsp/listUser.jsp" target="rightFrame">用户列表</a></li>
            <li><a href="<%=path%>/jsp/addUser.jsp" target="rightFrame">添加用户</a></li>
        ...
        <li>
            <div class="header">
            <cite></cite>
            <a href="showGoods.jsp" target="rightFrame">收银</a>
            <i></i>
            </div>                
            <ul class="sub-menus">
    ...
    <dd>
    <div class="title">
    <span><img src="<%=path %>/static/images/leftico02.png" /></span>其他设置
    </div>
    <ul class="menuson">
    ...
    <dd><div class="title"><span><img src="<%=path %>/static/images/leftico04.png" /></span>日期管理</div>
    <ul class="menuson">
        <li><cite></cite><a href="#">自定义</a><i></i></li>
        <li><cite></cite><a href="#">常用资料</a><i></i></li>
        <li><cite></cite><a href="#">信息列表</a><i></i></li>
