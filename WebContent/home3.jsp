				...
				<ul class="message-l">
					<div class="topMessage">
						<div class="menu-hd">
							...
							<c:if test="${userName != null}">
								<a href="${ctxPath}/person/information.jsp" target="_top" class="h">${userName}你好！</a>
							</c:if>
						</div>
					</div>
				</ul>
				<ul class="message-r">
					...
					<div class="topMessage my-shangcheng">
						<div class="menu-hd MyShangcheng">
							<c:if test="${userName != null}">
								<a href="${ctxPath}/person/information.jsp " target="_top">
							</c:if>
							<c:if test="${userName == null}">
								<a id="mc-menu-hd" href="home/login.jsp" target="_top">
							</c:if>
					...
					<div class="topMessage mini-cart">
						<div class="menu-hd">
						<c:if test="${userName != null}">
							<a id="mc-menu-hd" href="home/shopcart.jsp" target="_top">
						</c:if>
						<c:if test="${userName == null}">
							<a id="mc-menu-hd" href="home/login.jsp" target="_top">
						</c:if>
